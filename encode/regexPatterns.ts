...
export let dataSegPattern = /^[\w]+:[ ]+[.][byte|dword|word|half|asciz]*[ ]+((0[xX][0-9a-fA-F]+|[\d]+)[ ]*,[ ]*)*(0[xX][0-9a-fA-F]+|[\d]+)[ ]*$/;
...
export let formatLoadFromDataPattern = /^[ ]*(lb|ld|lh|lw|)[ ]+x([3][0-1]|[1-2][0-9]|[0-9])[ ]*,[ ]*[\w]+[ ]*$/;
export let formatSPattern = /^[ ]*(sb|sd|sh|sw|)[ ]+x([3][0-1]|[1-2][0-9]|[0-9])[ ]*,[ ]*[-]?(0[xX][0-9a-fA-F]+|[\d]+)[(]x([3][0-1]|[1-2][0-9]|[0-9])[)][ ]*$/;
